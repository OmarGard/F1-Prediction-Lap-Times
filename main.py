...
from scripts.session_data import get_session_results, load_session_data
...
from scripts.utils import (
    ...
    add_wet_performance_factor,
    add_team_performance_score,
    fill_missing_total_times
)
...
if weather_forecast in ["Rain", "Drizzle", "Thunderstorm"]:
...
# Features and target
X = merged[[
    "QualifyingTime", "TrackTemperature", "TeamPerformanceScore", "RainIntensity", "CleanAirRacePace (s)"
]]
